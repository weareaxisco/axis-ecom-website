...
export const getOutlookCalendarUrl = (appointment) => {
  const { start, end } = appointmentDateTimes(appointment)
  const params = new URLSearchParams({
