...
export default function Catalog() {
  ...
  const filteredProducts = useMemo(() => {
    const filtered = products.filter((product) => {
      ...
      const collection = normalize(product.collection_name || product.collection?.name || product.collection)
      const tags = (Array.isArray(product.tags) ? product.tags : product.tags ? [product.tags] : []).map(normalize)
