...
export default function AdminAddProductModal({ onClose, onCreated, initialProduct = null, onUpdated }) {
  ...
  const [form, setForm] = useState(() => initialProduct ? { ...initialProduct, sku: initialProduct.sku || '', tags: Array.isArray(initialProduct.tags) ? initialProduct.tags : initialProduct.tags ? [initialProduct.tags] : [], name: initialProduct.name || initialProduct.title || '', category: initialProduct.category || fallbackCategories[0], collection: initialProduct.collection || fallbackCollections[0], price_dh: initialProduct.price_dh ?? initialProduct.price ?? '', images: Array.isArray(initialProduct.images) ? initialProduct.images.join('\n') : initialProduct.images || '', stock: initialProduct.stock ?? '0', onsite_only: Boolean(initialProduct.onsite_only) } : { name: '', sku: '', tags: [], category: fallbackCategories[0], collection: fallbackCollections[0], price_dh: '', images: '', description: '', material: '', metal: '', gender: '', shape: '', novelty: '', stock: '0', onsite_only: false })
