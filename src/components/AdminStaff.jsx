...
export default function AdminStaff() {
  ...
  const openEdit = (member) => {
    ...
    if (!canModifyTarget(user?.role, member.role)) return
  ...
  const save = async (event) => {
    ...
    try {
      ...
      const role = assignableRoles.includes(form.role) ? form.role : 'staff_catalog'
