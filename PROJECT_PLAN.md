...
- [x] Complete the remaining full-site hardcoded-string audit across small legacy storefront surfaces; BagDrawer, ProductCard, ProductCatalog, authentication/signup, legal, Concierge, feedback, footer, Careers, Boutique, Checkout, Search, Account, Admin workflows, product details, enquiries, and size guidance are localized. Database-derived product, order, status, and taxonomy values remain intentionally data-driven.