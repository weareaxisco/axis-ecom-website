...
- [ ] Complete the remaining full-site hardcoded-string audit across Admin Settings and secondary storefront surfaces; legal, Concierge, feedback, footer, Careers, Boutique, Checkout, Search, Account, Admin appointments/staff/product creation, and core product labels are now localized.