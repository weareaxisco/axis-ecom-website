...
- [ ] Complete the remaining full-site hardcoded-string audit across secondary storefront surfaces; legal, Concierge, feedback, footer, Careers, Boutique, Checkout, Search, Account, and Admin workflows are now localized.